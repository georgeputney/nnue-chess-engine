...
(near-random, legal moves only); `stages/08-single-nnue` is a flattened build of
...
| [08-single-nnue](08-single-nnue) | NNUE evaluation (single net), Syzygy probe | the gap that closed 0-6 vs the fork above |
